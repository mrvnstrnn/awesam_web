...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['Calendar', 'mycalendar', 'My Calendar', 'Activities tracker', 'profile_menu', 'schedule', ''],
            ['Tasks', 'mytasks', 'My Tasks', 'Tasks tracker', 'profile_menu', 'schedule', ''],
            ['Requests', 'myrequests', 'My Requests', 'Request tracker', 'profile_menu', 'schedule', ''],
            ['Calendar', 'teamcalendar', 'Team Calendar', 'Activities tracker', 'profile_menu', 'schedule', ''],
            ['Team Tasks', 'teamtasks', 'Team Tasks', 'Team task management', 'profile_menu', 'tasks', ''],
            ['Requests', 'teamrequests', 'Team Requests', 'Request tracker', 'profile_menu', 'schedule', ''],
