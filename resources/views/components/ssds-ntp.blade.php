    ...
    <div class="col-12">
        <div class="table-responsive aepm_table_div pt-4">
            ...
            <div class="text-right" style="margin:0px;">
                <button type="button" id="submit_not_assds" class="btn btn-lg btn-secondary mark_as_complete">SSDS NTP Not Applicable</button>
                <button type="button" id="submit_assds" class="btn btn-lg btn-primary mark_as_complete">Submit SSDS NTP</button>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        var sam_id = "{{ $sam_id }}";
        var status = "jtss_schedule_site_approved";
            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (!resp.error){
                        ...
                        $("#submit_not_assds").text("SSDS NTP Not Applicable");

                        $("#submit_assds").removeAttr("disabled");
                        $("#submit_assds").text("Submit SSDS NTP");
