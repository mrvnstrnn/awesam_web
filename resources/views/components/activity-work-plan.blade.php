...
<style>
                        ...
                        <div class="main-card card ">
                                    ...
                                    <div class="row px-0" id="control_form_log">
                                        <div class="col-12">                                
                                            <form id="add_worplan_form" class="add_worplan_form">
                                                ...
                                                <div class="position-relative row form-group">
                                                    <label for="sub_activity_id" class="col-sm-3 col-form-label">Subactivity</label>
                                                    <div class="col-sm-9">
                            ...
                            <div class="card-footer">
                                <div class="col-12  text-right p-0">
                                    ...
                                    <button class="btn btn-secondary btn-lg show_add_activity_work_plan add_activity_work_plan" data-log="true" type="button">View Activity Workplan</button>
                                    <button class="btn btn-primary btn-lg save_activity_work_plan add_activity_work_plan" data-log="true" type="button">Save Activity Work Plan</button>
                                </div>
                            </div>
                        </div>
                    </div>                
    ...
    $(document).ready(() => {
        ...
        $('.show_add_activity_work_plan').on('click', function(e){
            e.preventDefault();
