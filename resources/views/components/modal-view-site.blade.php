                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12">
                        <div class="main-card mb-3 card ">
                            ...
                            <div class="card-body">
                                ...
                                @else
                                    @if(in_array($main_activity, $forced_actions))
                                        <x-site-action-view :site="$site" :main_activity="$main_activity" :rtbdeclaration="$rtbdeclaration" />
                                    @else  --}}
                                    ...
                                    <div id="site_details_view" class="{{ $site_details_view }}">                                    
                                        ...
                                        {{-- <x-site-detail-view :site="$site" :main_activity="$main_activity" :site_fields="$site_fields" />
                                    @endif
                                @endif --}}
                            </div>
                        </div> 
