                ...
                <tr>
                    ...
                    <td style="width: 100%; text-align: left; border: 1px solid black; padding: 10px; margin: 0px;">
                        ...
                        <p style="text-align: justify; text-justify: inter-word;"><b>D.</b>
                            Escalation Rate: <span style="text-decoration: underline;">{{ ucwords(numberTowords( $json->lessor_demand_escalation_rate * 100 )) }}</span> percent (<span style="text-decoration: underline;">{{ $json->lessor_demand_escalation_rate * 100 }}</span>%) per year beginning on the <span style="text-decoration: underline;">{{ $json->lessor_demand_escalation_year }}</span> year/s of the leased term.
                        </p>
