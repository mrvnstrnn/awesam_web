                        ...
                        <div class="main-card mb-3 card">
                                ...
                                <div class="dropdown-menu-header-inner bg-dark">
                                    ...
                                    <div class="menu-header-content btn-pane-right">
                                        ...
                                        <div class="btn-actions-pane-right">
                                            ...
                                            <span class="badge badge-danger text-lg mb-0 p-2" style="font-size: 12px;">{{ $main_activity }}</span>
                                        </div>                                            
                                    </div>
                                </div>
                            </div> 
                            ...
                            <div class="card-body">
                                <div class="row  border-bottom mb-3">
                                    <div class="col-12">
                                        <ul class="tabs-animated body-tabs-animated nav">
                                            <li class="nav-item">
                                                <a role="tab" class="nav-link" id="tab-details" data-toggle="tab" href="#tab-content-details">
                                                    <span>Details</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a role="tab" class="nav-link active" id="tab-files" data-toggle="tab" href="#tab-content-files">
                                                    <span>Files</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane tabs-animation fade" id="tab-content-details" role="tabpanel">
                                    ...
                                    <div class="tab-pane tabs-animation fade active show" id="tab-content-files" role="tabpanel">
                            ...
                            <div class="card-footer d-block text-right bg-dark">
                                <button id="" class=" mt-0 btn btn-success" type="button">Approve RTB Docs</button>
                            </div>
                            @endif
                        </div>
                    </div>
