                        ...
                        <div class="main-card mb-3 card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    @endphp
                                    <table id="new-endoresement-{{ strtolower(str_replace(" ", "-", $program->program))  }}-table" class="align-middle mb-0 table table-borderless table-striped table-hover new-endorsement-table" data-href="{{ route('all.getDataNewEndorsement', [\Auth::user()->profile_id, $program->program_id, $program->activity_id, $activity_id->what_to_load]) }}">
                                        <thead>
                                            <tr>
                                                <th style="width: 15px;">
