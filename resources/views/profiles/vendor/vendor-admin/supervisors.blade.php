                ...
                success: function (resp) {
                    if (!resp.error) {
                        ...
                        resp.user_data.forEach(element => {
                            $(".supervisor_info_form .user_data input[type=checkbox][value='" + element.program_id + "']").prop('checked', true);
                        });

                        resp.user_areas_data.forEach(element => {
                            $(".supervisor_info_form .region_data input[type=checkbox][value='" + element.region + "']").prop('checked', true);
                        });
