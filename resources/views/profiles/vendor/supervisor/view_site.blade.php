...
<div class="row" style="margin-top: -30px;">
    ...
    <div class="col-md-4">
        <ul class="tabs-animated body-tabs-animated nav">
            <li class="nav-item">
                <a role="tab" class="nav-link active" id="tab2-1" data-toggle="tab" href="#tab2-content-1">
                    <span>Agent</span>
                </a>
            </li>
            <li class="nav-item">
                <a role="tab" class="nav-link" id="tab2-0" data-toggle="tab" href="#tab2-content-0">
                    <span>Chat</span>
                </a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            <div class="tab-pane tabs-animation fade active show" id="tab2-content-1" role="tabpanel">
                                    ...
                                    <div class="widget-content-left mr-3">
                                        <div class="icon-wrapper m-0">
                                            <div class="progress-circle-wrapper">
                                                <div class="circle-progress d-inline-block circle-progress-success-sm"><canvas width="3" height=""></canvas>
            ...
            <div class="tab-pane tabs-animation fade" id="tab2-content-0" role="tabpanel">
