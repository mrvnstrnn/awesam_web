                        ...
                        <div class="main-card mb-3 card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="agent-{{ strtolower(str_replace(" ", "-", $program->program))  }}-table" class="align-middle mb-0 table table-borderless table-striped table-hover unasigned-table new-endorsement-table" data-href="{{ route('all.newagent', $program->program_id) }}">
                                        <thead>
                                            <tr>
