...
@section('js_script')
    <script>
        $(document).on("click", ".modalDataSite", function(){
            ...
            $("#modal-unassigned-sites").modal("show");
        });
    </script>
@endsection
...
@section('modals')
    ...
    <div class="modal fade" id="modal-unassigned-sites" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true" data-backdrop="static" data-keyboard="false">
