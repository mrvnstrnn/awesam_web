...
<div class="tab-content">
    ...
    @php
        $sites = \DB::connection('mysql2')
            ...
            ->select('sam_id', 'site_name', 'site_category', 'program_id', 'site_agent_id')
            ->distinct()
            ->where('site_IS_id', "=", \Auth::id())
            ->orderBy('site_agent_id') 
            ->orderBy('program_id') 
            ->get();
                        ...
                        <div class="card">
                            <div id="headingOne" class="card-header">
                                <button type="button" data-toggle="collapse" data-target="#collapse-{{ $site->sam_id }}" aria-expanded="true" aria-controls="collapseOne" class="text-left m-0 p-0 btn btn-link text-dark btn-block">
                                    <div class="row">
                                        <img width="35" height="35" class=" ml-3 mr-2 rounded-circle" src="images/avatars/4.jpg" alt="">                                        
                                        <div class="">
