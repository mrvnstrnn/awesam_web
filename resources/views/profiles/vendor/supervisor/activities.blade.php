...
<div class="tab-content activities_to_load">
    @php
        $activities = \DB::connection('mysql2')->select('call `supervisor_team_activities`('.\Auth::id().')');

        $activities = array_filter($activities, function ($a) use ($agent_id) {
            return $agent_id == "" ? $a->agent_id != $agent_id : $a->agent_id == $agent_id;
        });

        usort($activities, "date_sort");
        
        // $my_agents = group_by_agent("agent_id", $activities);
        ...
        // function filtered_agent($a, $b = "") {
        //     return $b == "" ? $a->agent_id != $b : $a->agent_id == $b;
        // }
        ...
        // function group_by_agent($key, $data) {
        //     $result = array();
            ...
            <div class="col-md-7">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-header-tab card-header">
                        ...
                        <div class="btn-actions-pane-right text-capitalize actions-icon-btn list-of-agent-dropdown">
                            <div class="btn-group dropdown">
                                <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn-icon btn-icon-only btn btn-link list-of-agent-dropdown-daily">
                                    <i class="pe-7s-menu btn-icon-wrapper"></i>
                                </button>
                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-right rm-pointers dropdown-menu-shadow dropdown-menu-hover-link dropdown-menu">
                                    <h6 tabindex="-1" class="dropdown-header">Agent</h6>
                                    <div class="dropdown-list-agent"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div data-parent="#accordion" id="dailycollapse{{ $j }}" class="collapse {{ $j == 0 ? "show" : "" }}">
                                        {{-- <div class="card-body"> --}}
                                            @for ($k = 0; $k < count($activities_groups[array_keys($activities_groups)[$j]]); $k++)
                                                <div class="list-agent-item{{$activities_groups[array_keys($activities_groups)[$j]][$k]->agent_id}}">
            ...
            <div class="col-md-7">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-header-tab card-header">
                        ...
                        <div class="btn-actions-pane-right text-capitalize actions-icon-btn list-of-agent-dropdown">
                            <div class="btn-group dropdown">
                                <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn-icon btn-icon-only btn btn-link list-of-agent-dropdown-weekly">
                                    <i class="pe-7s-menu btn-icon-wrapper"></i>
                                </button>
                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-right rm-pointers dropdown-menu-shadow dropdown-menu-hover-link dropdown-menu">
                                    <h6 tabindex="-1" class="dropdown-header">Agent</h6>
            ...
            <div class="col-md-7">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-header-tab card-header">
                        ...
                        <div class="btn-actions-pane-right text-capitalize actions-icon-btn list-of-agent-dropdown">
                            <div class="btn-group dropdown">
                                <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn-icon btn-icon-only btn btn-link list-of-agent-dropdown-monthly">
                                    <i class="pe-7s-menu btn-icon-wrapper"></i>
                                </button>
                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-right rm-pointers dropdown-menu-shadow dropdown-menu-hover-link dropdown-menu">
                                    <h6 tabindex="-1" class="dropdown-header">Agent</h6>
                                    <div class="dropdown-list-agent"></div>
                                    {{-- @for ($n = 0; $n < count(array_keys($my_agents)); $n++)
                                        <button type="button" value="{{ $my_agents[array_keys($my_agents)[$n]][0]->agent_id }}" tabindex="0" class="dropdown-item">

                                            <i class="dropdown-icon lnr-user"> </i><span>
                                                
                                                {{ $my_agents[array_keys($my_agents)[$n]][0]->agent_name }}
...
@section('js_script')
    <script src="{{ asset('js/supervisor-activities.js') }}"></script>
    <script>
        // $(document).on("click", ".agent_filter_activities", function (){
        //     var agent_id = $(this).val();
        //     console.log(".list-agent-item"+agent_id);
        //     $(".list-agent-item"+agent_id).addClass("d-none");
        // });
