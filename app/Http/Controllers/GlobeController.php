            ...
            $dt = DataTables::of($checkAgent)
                    ->addColumn('photo', function($row){
                        if (is_null($row->image)) {
                            return '<img width="42" height="42" class="rounded-circle offline" src="images/no-image.jpg" alt="">';
                        } else {
                            return '<img width="42" height="42" class="rounded-circle offline" src="'.asset('files/'.$row->image).'" alt="">';
                        }
                    })
